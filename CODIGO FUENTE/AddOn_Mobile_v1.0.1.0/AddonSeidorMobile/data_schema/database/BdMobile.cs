...
namespace AddonSeidorMobile.data_schema.database
{
    public class BdMobile
    {
        ...
        public static List<string> getInserts()
        {
            ...
            list.Add("DELETE FROM \"" + BD_NAME + "\".\"" + TB_MOTIVOS_INCIDENCIAS + "\"");
            ...
            list.Add("DELETE FROM \"" + BD_NAME + "\".MENU");
            list.Add("INSERT INTO \"" + BD_NAME + "\".MENU  values (1, 'Socios de negocio', '01')");
            list.Add("INSERT INTO \"" + BD_NAME + "\".MENU  values (2, 'Inventario', '02')");
            list.Add("INSERT INTO \"" + BD_NAME + "\".MENU  values (3, 'Pedidos', '03')");
            list.Add("INSERT INTO \"" + BD_NAME + "\".MENU  values (4, 'Facturas', '04')");
            list.Add("INSERT INTO \"" + BD_NAME + "\".MENU  values (5, 'Cobranzas', '05')");
            list.Add("INSERT INTO \"" + BD_NAME + "\".MENU  values (6, 'Puntos de visita', '06')");
            list.Add("INSERT INTO \"" + BD_NAME + "\".MENU  values (7, 'Incidencias', '07')");
            list.Add("INSERT INTO \"" + BD_NAME + "\".MENU  values (8, 'Devoluciones', '08')");
            list.Add("INSERT INTO \"" + BD_NAME + "\".MENU  values (9, 'Notas de crédito', '09')");
            list.Add("INSERT INTO \"" + BD_NAME + "\".MENU  values (10, 'Entregas', '10')");
            list.Add("INSERT INTO \"" + BD_NAME + "\".MENU  values (11, 'Reportes', '11')");
